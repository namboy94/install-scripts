...
pacaur -S numix-icon-theme-git arc-gtk-theme
echo "Set Window Borders to Arc-Darker"
echo "Set Icons to Numix"
echo "Set Controls to Arc-Dark"
echo "Set Desktop to Arc-Dark"